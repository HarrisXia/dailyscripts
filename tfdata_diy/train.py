...
#这个都不需要改~这段的内容在执行的时候加上就可以了~
#python train.py --train_dir='E:\models\research\object_detection\data\output' --pipeline_config_path='E:\models\research\object_detection\faster_rcnn_inception_v2_coco.config

					 
flags.DEFINE_string('train_dir', 'data\\checkpoint',
